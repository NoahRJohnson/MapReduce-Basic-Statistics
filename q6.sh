...
python collegeStratifiedSample.py Example\ Data/colleges_no_header.csv --jobconf my.job.settings.numPubColleges=$(echo $pubCount --jobconf my.job.settings.numPrivColleges=$(echo $privCount))
